...
_GT_POLY_ROOT = '//Salmon/User/Chen/Vessel_data/Nara_enhance_plain/Good alignment/crop_hip_joint/seperation_left_right/Polygons'
    # '//Salmon/User/mazen/Segmentation/Codes/results/Nara/hip_vessels/18_5fold/seperation_left_right/Polygons'
    # '//Salmon/User/Chen/Vessel_data/Dataset for Distance Assessment/crop_vessels_pelvis_36cases/seperation_left_right/Polygons'
_Rim_ROOT = '//Salmon/User/Chen/Vessel_data/Nara_enhance_plain/Good alignment/crop_hip_joint/seperation_left_right/Polygons/rim_points'
...
_FIG_TGT = '//Salmon/User/Chen/Vessel_data/Nara_enhance_plain/Good alignment/crop_hip_joint/seperation_left_right/Polygons/PolyFigures_Rim'
...
_Dis_TGT_vessel = '//Salmon/User/Chen/Vessel_data/Nara_enhance_plain/Good alignment/crop_hip_joint/seperation_left_right/Polygons/PolyDistances_Vessel'
_Dis_TGT_index = '//Salmon/User/Chen/Vessel_data/Nara_enhance_plain/Good alignment/crop_hip_joint/seperation_left_right/Polygons/PolyDistances_pelvis_id'
...
def VisualizeSurfaceDistance(
    ...
    try:
        ...
        for i in range(0, points.GetNumberOfPoints(), 1):
            ...
            Pelivis_index.append(Pelvis_closet_id)
        ...
        np.savetxt(os.path.join(_Dis_TGT_vessel, '%s_%s.csv' % (case, _SRC_STRUCT)), Closest_points, fmt='%0.4f',
                   delimiter=",")
        Pelivis_index = np.array(Pelivis_index)
