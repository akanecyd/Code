...
_Rim_ROOT = '//Salmon/User/Chen/Vessel_data/Dataset for Distance Assessment/crop_vessels_pelvis_36cases/seperation_left_right/Polygons/acetablum_points'
...
_FIG_TGT = '//Salmon/User/Chen/Vessel_data/Dataset for Distance Assessment/crop_vessels_pelvis_36cases/seperation_left_right/Polygons/PolyFigures_Rim'
...
_Dis_TGT = '//Salmon/User/Chen/Vessel_data/Dataset for Distance Assessment/crop_vessels_pelvis_36cases/seperation_left_right/Polygons/PolyDistances'
_Dis_TGT_vessel = '//Salmon/User/Chen/Vessel_data/Dataset for Distance Assessment/crop_vessels_pelvis_36cases/seperation_left_right/Polygons/PolyDistances_Vessel'
...
os.makedirs(_Dis_TGT_index, exist_ok=True)
_DIST_MINMAX = (0, 20)
AZs = [95, 125, 155]
# AZs = [125]
_SUB_ALPHAS  =[0.3,
...
def VisualizeSurfaceDistance(
    ...
    try:
        ...
        np.savetxt(os.path.join(_Dis_TGT_vessel, '%s_%s.csv' % (case, _SRC_STRUCT)), Closest_points, fmt='%0.4f',
                   delimiter=",")
        Pelivis_index = np.array(Pelvis_index)
        np.savetxt(os.path.join(_Dis_TGT_index, '%s_%s.csv' % (case, _SRC_STRUCT)), Pelivis_index, fmt='%d',
                   delimiter=",")
