...
def get_color_configs(tgt):
    ...
    """   
    color, opacity,gopacity = [], [], []
    filenameColorfile, filenameOpacityfile, filenameGOpacityfile = None, None, None
    ...
    if tgt == 'ct_bone_pyvr':
    ...
    elif tgt == 'label_obt_int':
        filenameColorfile    = "./TFs/Labels_color_tf.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_obt_int_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"
    elif tgt == 'label_muscle_hip_bw':
        filenameColorfile    = "./TFs/Labels_color_tf_bw.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"
        ...
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"
    elif tgt == 'label_muscle_hip_mri_24':
        filenameColorfile    = "./TFs/Labels_mri_24_color_tf.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"
        ...
        filenameColorfile    = "./TFs/Labels_Skin_color_tf.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_skin_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"        
    elif tgt == 'label_skin_bw':
        filenameColorfile    = "./TFs/Labels_Skin_color_tf_bw.txt"
        ...
        filenameColorfile    = "./TFs/Labels_bone_vessel_color_tf.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"
        ...
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"  
    elif tgt == 'label_hip_to_foot':
        filenameColorfile    = "./TFs/Labels_HipToFoot_color_tf.txt"
        filenameOpacityfile  = "./TFs/Labels_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Labels_gopacity_tf.txt"  
    ...
    elif tgt == 'muscle_ratio_bw':
        filenameColorfile    = "./TFs/Muscle_ratio_bw_color_tf.txt"
        filenameOpacityfile  = "./TFs/Muscle_ratio_opacity_tf.txt"
        filenameGOpacityfile = "./TFs/Muscle_ratio_gopacity_tf.txt" 
        ...
        filenameColorfile    = "./TFs/jet.txt"
    elif tgt == 'jet_r':
        filenameColorfile    = "./TFs/jet_r.txt"
    elif tgt == 'viridis':
        filenameColorfile    = "./TFs/viridis.txt"
    elif tgt == 'coolwarm':
        filenameColorfile    = "./TFs/coolwarm.txt"
    elif tgt == 'bwr':
        filenameColorfile    = "./TFs/bwr.txt"

    else:
        raise NotImplementedError
    
    if filenameColorfile is not None:
        color = get_color_from_csv(filenameColorfile)
    if filenameOpacityfile is not None:
        opacity = get_scalar_from_csv(filenameOpacityfile)
    if filenameGOpacityfile is not None:
...
def cast_reader_toshort(reader):
    """
...
def get_color_trans_func(color_dict, keys=None):
    """
    ...
    if keys is None:
       ...
       for idx in keys:
        ...
        keys = np.linspace(keys[0], keys[1], len(color_dict))
        for idx, val in enumerate(keys):
            funcColor.AddRGBPoint(val, 
                                color_dict[idx][0],
                                color_dict[idx][1],
                                color_dict[idx][2], 0.5, 1.0)
...
def get_polydata_writer(polydata, fpath):
    '''
    Function to save polygon data.
    Inputs: 
        polyreader: vtkPolyData object
...
def get_poly_writer(polyreader, fpath):
    '''
    Function to save polygon data.
    Inputs: 
...
def get_poly_actor(polyreader, edge_visible=False,col=(0.35, 0.3, 0.20), alpha=0.6):
    ...
    if edge_visible:
        ...
        plyActor.GetProperty().SetEdgeColor(0.8, 0.8, 0.8)
    return plyActor
...
def get_distance_actor(dist_filter, minmax = None, lut=None):
    plyMapper = vtk.vtkPolyDataMapper()
...
def get_scalar_bar_actor(mapper, lut=None):
...
def get_masked_data(mask_data, image_data, val=-1024, cast=False):
    mask = vtk.vtkImageMask() 
    mask.SetImageInputData(image_data)   
    if cast: 
        caster = vtk.vtkImageCast()
        caster.SetInputData(mask_data)
        caster.SetOutputScalarTypeToUnsignedChar()
        mask.SetMaskInputData(caster.GetOutput())
    else:
        mask.SetMaskInputData(mask_data)
    mask.SetMaskedOutputValue(val)
    mask.Update()
