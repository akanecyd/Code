...
_GT_POLY_ROOT = '//Salmon/User/mazen/Segmentation/Codes/results/Nara/hip_vessels/18_5fold/seperation_left_right/Polygons'
...
_FIG_TGT =  '//Salmon/User/mazen/Segmentation/Codes/results/Nara/hip_vessels/18_5fold/seperation_left_right/Polygons/PolyFigures_CEll_20230220'
...
_Dis_TGT =  '//Salmon/User/mazen/Segmentation/Codes/results/Nara/hip_vessels/18_5fold/seperation_left_right/Polygons/PolyDistances_20230214'
_Dis_TGT_vessel =  '//Salmon/User/mazen/Segmentation/Codes/results/Nara/hip_vessels/18_5fold/seperation_left_right/Polygons/PolyDistances_Vessel_20230214'
...
def VisualizeSurfaceDistance(
    ...
    try:
        ...
        original_points = _RIM_reader.GetOutput().GetPoints().GetData()
        original_points = VTK_Helper.vtk_to_numpy(original_points)
        if _side == 'right':
            indices = sort_points_anti_clockwise(original_points)
        elif _side == 'left':
            indices = sort_points_clockwise(original_points)
        ...
        for i in range(0, points.GetNumberOfPoints(), 1):
            ...
            point = points.GetPoint(indices[i])
        ...
        for i in range(len(Pelvis_index)):
            ...
            for j in range(cell_ids.GetNumberOfIds()):
                ...
                # Set the color of the cell depending on the minimum distance
        ...
        # Set the position and orientation of the scalar bar
        ...
        # scalarBarWidget.GetScalarBarActor().SetPosition(0.9, 0.1)
        # scalarBarWidget.GetScalarBarActor().SetWidth(0.1)
        # scalarBarWidget.GetScalarBarActor().SetHeight(0.6)
